"""CLI module for the calculator.

Encapsulates argument validation, operand parsing, operation dispatch, and
output formatting for the bash command-line interface.  The entry point in
main.py is a thin wrapper that delegates to CLIHandler.
